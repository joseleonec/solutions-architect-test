...
Prueba técnica de Arquitecto de Soluciones: diseño de arquitectura para un sistema de banca por internet de BP (Ecuador), usando el modelo C4.

**Autor:** José Luis León · joleonca@gmail.com
...
El PDF es autocontenido y es el punto de partida recomendado. Los archivos en `other/` sustentan las decisiones que ahí se resumen, por si se quiere profundizar en algún punto puntual.
